	...
	<body>
		<div id="container">
			...
			<div id="content">
				...
				<div id="main">
					<h3>Motherboards<br></h3>
					<?php
						$query = "SELECT productID, productName, productType, productDescription, Price, Quantity, Image FROM products WHERE (productType LIKE 'Motherboards');";
