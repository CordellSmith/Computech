			...
			<div id="content">
				...
				<div id="main">
					...
					<div class="sliderContainer">
						<img class="mySlides" src="images/web-banner.jpg">
						<img class="mySlides" src="images/web-banner2.jpg">
						<img class="mySlides" src="images/web-banner3.png">
					</div>
					<div id="content">
						<p><b>Our Specials</b></p>
						<div id="product_specials">
							<?php
								$query = "SELECT productID, productName, productType, productDescription, Price, Quantity, Image FROM products WHERE (Quantity <= 10);";
